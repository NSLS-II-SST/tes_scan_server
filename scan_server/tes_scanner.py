...
class TESScanner():
    ...
    def make_projectors(self, noise_file, pulse_file):
        args = ["make_projectors", "-rio", "/home/decker/.scan_server/projectors.hdf5", pulse_file, noise_file]
        print(args)
    ...
    # Update File Path                                  #
    #####################################################
    def set_projectors(self, projector_filename="/home/decker/.scan_server/projectors.hdf5"):
    ...
    """
    def rsync_data(self, dest=None, filename=None):
        if filename is None:
